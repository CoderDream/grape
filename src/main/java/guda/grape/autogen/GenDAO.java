...
public class GenDAO {
    ...
    private String doVmName = "do.vm";

    private String daoVmName = "dao.vm";
    private String daoImplVmName = "dao_impl.vm";
    private String sqlmapVmName = "sqlmap.vm";
    ...
    public void gen(String tableName,String tablePrefix)  {
        ...
        String doFile = genContext.getBaseDir() + File.separator + GenConstants.javaDir + File.separator + packageDir
                + File.separator + "dataobject" + File.separator + genContext.getDoName() + "DO.java";
        ...
        String sqlmapFile = genContext.getBaseDir() + File.separator + GenConstants.resourceDir + File.separator + "mybatis" + File.separator+genContext.getTableName()+".xml";
        ...
        params.put(VP_DO_PACKAGE, parentPackageName+".dataobject");
        ...
        try{
            String render = VelocityHelper.render(doVmName, params);
        ...
        try {
            String render = VelocityHelper.render(daoVmName, params);
            ...
            render = VelocityHelper.render(daoImplVmName, params);
            fileName = genContext.getDaoImplFile();
            file = new File(fileName);
            file.getParentFile().mkdirs();
            if (file.exists()) {
                fileName += ".c";
            ...
            render = VelocityHelper.render(sqlmapVmName, params);
