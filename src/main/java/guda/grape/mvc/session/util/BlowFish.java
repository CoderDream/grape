package guda.grape.mvc.session.util;
...
//      System.out.println(hexString(bf.decrypt(bf.encrypt(hex2byte("0756D8E0774761D2")))));
        ...
        System.out.println(bf.encrypt("3"));
        System.out.println(bf.decrypt(bf.encrypt("3")));
        System.out.println(bf.decrypt(bf.encrypt("你好   |")));
